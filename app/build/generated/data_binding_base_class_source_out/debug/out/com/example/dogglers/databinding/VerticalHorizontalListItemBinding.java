...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView ageDoggler, @NonNull TextView hobbiesDoggler,
      @NonNull ImageView imageViewDoggler, @NonNull TextView nameDoggler) {
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, ageDoggler,
          hobbiesDoggler, imageViewDoggler, nameDoggler);
    }
